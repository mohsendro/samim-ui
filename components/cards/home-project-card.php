...
<div class="home-project-card">
    <div class="content">
        ...
        <a href="#" class="title" title="">تولید و تامین تجهیزات واسط صدا و تصویر به منظور اچ دی سازی شبکه های رسانه ملی</a>
        <p class="desc">
...
<div class="home-project-card">
    <div class="content">
        ...
        <a href="#" class="title" title="">سامانه کنترل و مانیتورینگ ایستگاه های تلویزیونی و FM کشور </a>
        <p class="desc">
